...
class Party{
	...
	public function addMember(Player $player){
		...
		if($player instanceof CorePlayer) $player->setParty($this);
	...
	public function disband(){
		...
		if($leader!==null){
			...
			if($leader instanceof CorePlayer) $leader->setParty(null);
			if($leader instanceof CorePlayer) $leader->setPartyRank(null);
		}
