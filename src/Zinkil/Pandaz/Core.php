...
use Zinkil\Pandaz\listeners\{ServerListener, AntiCheatListener, WorldListener, ItemListener, PlayerListener, PvPUtilsListener, TNTListener, BlockListener, AntiAdvertisingListener, AntiSwearingListener, AntiToxicListener};
...
class Core extends PluginBase{
	...
	public function onEnable():void{
		...
		$this->getServer()->loadLevel("rushffa");
