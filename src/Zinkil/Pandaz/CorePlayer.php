...
class CorePlayer extends Player{
	...
	public function isYoutube():bool{
		return $this->getRank()=="YouTube";
	}

	public function isFamous():bool{
		return $this->getRank()=="Famous";
	}
	...
	public function isHeadMod():bool{
		return $this->getRank()=="HeadMod";
	}
