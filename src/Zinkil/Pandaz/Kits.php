...
class Kits{
	...
	public static function sendMatchKit($player, $kit){
		switch($kit){
			...
			$player->getInventory()->setItem(3, $goldenhead);
			$player->getInventory()->setItem(4, Item::get(325, 8, 1));
			$player->getInventory()->setItem(5, Item::get(325, 10, 1));
			$player->getInventory()->setItem(6, Item::get(5, 0, 64));
			$player->getInventory()->setItem(7, Item::get(4, 0, 64));
			$player->getInventory()->setItem(8, Item::get(278, 0, 1));
			$player->getInventory()->setItem(9, Item::get(279, 0, 1));
