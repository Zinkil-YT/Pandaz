...
class Utils{
	...
	public static function tridentHitSound($player){
		$player=self::getPlayer($player);
		if(is_null($player)) return;
		$sound=new PlaySoundPacket();
    ...
    public static function levelupSound($player){
		if($player instanceof Player){
			$player=self::getPlayer($player);
		}else{
			$player=$player;
    ...
    public static function cancelSound($player){
		if($player instanceof Player){
			$player=self::getPlayer($player);
		}else{
			$player=$player;
    ...
    public static function spawnSound($player){
		if($player instanceof Player){
			$player=self::getPlayer($player);
		}else{
			$player=$player;
